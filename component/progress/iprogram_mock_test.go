...
func (_m *MockProgram) Update(key string, _a1 float64, status Status, msgFormat ...any) {
	var _ca []any
...
func (_c *MockProgram_Update_Call) Run(run func(key string, _a1 float64, status Status, msgFormat ...any)) *MockProgram_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(string), args[1].(float64), args[2].(Status), variadicArgs...)
	})
	return _c
}
...
func (_c *MockProgram_Update_Call) RunAndReturn(run func(string, float64, Status, ...any)) *MockProgram_Update_Call {
	_c.Run(run)
	return _c
}
